...
def extract_page_plan(page: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "layout_recommendation": copy.deepcopy(page.get("layout_recommendation", {})) if isinstance(page.get("layout_recommendation"), Mapping) else {},
        "layout_candidates": copy.deepcopy(page.get("layout_candidates", [])) if isinstance(page.get("layout_candidates"), list) else [],
