...
from ppt_system.image.component_geometry import bbox_gap, component_bbox, merge_bbox
from ppt_system.image.component_color_signature import enrich_component_with_color_signature
from ppt_system.image.component_stroke_features import (
    component_border_contact_count,
    is_colored_stroke_fragment,
    is_vivid_colored_component,
)
from ppt_system.image.component_postprocess import merge_component_group
