...
from ppt_system.image.asset_output_dir import prepare_asset_output_dir
from ppt_system.image.component_color_signature import annotate_component_color_signatures
from ppt_system.image.component_color_grouping import merge_color_coherent_fragments
from ppt_system.image.component_container_analysis import (
    annotate_barrier_regions,
    annotate_container_features,
    build_container_barrier_mask,
)
from ppt_system.image.component_graph_clustering import (
    merge_structural_components,
    split_suspicious_sparse_components,
)
from ppt_system.image.component_bridge_cut import cut_container_bridges
from ppt_system.image.component_icon_grouping import merge_local_icon_fragments
from ppt_system.image.component_instance_grouping import group_components_into_instances
from ppt_system.image.component_postprocess import merge_dashed_line_components
