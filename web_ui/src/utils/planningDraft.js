...
export function normalizePagePlan(page = {}, index = 0) {
  return {
    ...
    layout_reason: asText(page.layout_reason),
    layout_locked: asBoolean(page.layout_locked),
    layout_user_confirmed: asBoolean(page.layout_user_confirmed),
    reference_regeneration_required: asBoolean(page.reference_regeneration_required),
    ...
    layout_slots: page.layout_slots && typeof page.layout_slots === 'object' ? page.layout_slots : {},
